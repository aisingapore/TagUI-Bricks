// This automation flow performs bulk registration for trainees
// through IMDA ICMS website (CITREP) used by course providers.
// You can use this template to modify parameters accordingly,
// and use the sample csv datatable for the batch automation.

// IMDA CITREP ICMS last updated date and version,
// found at bottom of webpage after logging in -
// Last updated: 01 Oct 2019 (66)
...
// To run this workflow, use - tagui citrep_upload.txt trainee_data.csv speed chrome
// to specify that you want to automate the batch of records in trainee_data.csv
// and without restarting Chrome browser for each iteration (to login only once).
