// This automation flow can be used to repeat or reschedule 
// a groceries order on RedMart base on a previous order.
// RedMart has no way to repeat or reschedule an order besides
// manually clicking to add item by item from an old order.
...
// This workflow was originally created in TagUI for Python
// (a Python package for RPA base on TagUI) and ported here.
