// This automation flow downloads a document from IRAS
// and uses OCR to extract information from the document.
// Accounting firms can do this at scale to download and
// automate part of their business processes for clients.
...
dom alert('Tax amount is ' + dom_json.tax_amount + ' for the property:\n\n' + dom_json.property_address)

// In this automation workflow, the PDF document is a text document,
// which has better ways to extract text content instead of using OCR.
// OCR is used for demo purpose to show how an image PDF may be handled.
